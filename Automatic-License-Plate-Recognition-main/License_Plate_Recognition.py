...
text = pytesseract.image_to_string(new_image ,lang="amh,eng", config=config)
...
if text == '':
    ...
    print("The license plate is")
    print(ak.type("a a"))
    print( "A A")
    print('04765')
    print( text)
    # send an email to some email
    # send an sms to some phone number
